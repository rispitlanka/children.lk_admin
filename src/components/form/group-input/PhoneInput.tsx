  ...
  return (
    <div className="relative flex">
      ...
      <input
        ...
        } rounded-[10px] border border-gray-200 bg-white py-3 px-4 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-500 focus:outline-none dark:border-gray-800 dark:bg-gray-dark dark:text-white/90 dark:placeholder:text-white/30`}
      />
