  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-[10px] border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-dark sm:w-[361px] lg:right-0"
      >
